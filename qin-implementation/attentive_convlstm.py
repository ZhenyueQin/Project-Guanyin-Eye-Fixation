...
class AttentiveConvLSTM(Layer):
    ...
    def get_initial_states(self, x):
        ...
        print('what is initial state: ', initial_state)
        print('what is this: ', K.zeros((self.nb_filters_out, self.nb_filters_in, 1, 1)))

        # initial_state = K.reshape(initial_state, initial_state.shape[1:])
        initial_state = K.conv2d(initial_state, K.zeros((self.nb_filters_out, self.nb_filters_in, 1, 1)), padding='valid')
